...
def get_movie():
    ...
    if top_recom:
     result.set(top_recom[0])
        ...
        result.set('Sorry no recommandations found:') 

    
ttk.Button(app, text='Find Recommendations',font=('Arial',15),command= get_movie).place(x=100,y=250)

ttk.Label(app,textvariable=result, font=('Arial',12)).place(x=100,y=300)
